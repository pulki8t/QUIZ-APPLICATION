...
THEME_COLOR = "#0000FF" #Blue color code
...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain) -> None:
        ...
        self.window = Tk()
        self.window.title("Quizairre- Quiz Application")
    ...
    def display_title(self):
        title = Label(self.window, text="Quizairre- Quiz Application", width=50, bg="purple", fg="white", font=("ariel", 20, "bold"))
        title.place(x=0, y=2)
    ...
    def buttons(self):
        next_button = Button(self.window, text="Next", command=self.next_btn, width=10, bg="green", fg="white", font=("ariel", 16, "bold"))
        next_button.place(x=350, y=460)
        quit_button = Button(self.window, text="Quit", command=self.window.destroy, width=5, bg="red", fg="white", font=("ariel", 16, " bold"))
